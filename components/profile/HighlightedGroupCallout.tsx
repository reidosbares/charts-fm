...
export default function HighlightedGroupCallout({ groups }: HighlightedGroupCalloutProps) {
  ...
  return (
    <div className="rounded-2xl p-4 border-2 border-dashed border-gray-300 bg-gray-50/50 mb-5">
      <div className="flex items-start gap-3">
        <div className="flex-shrink-0 w-9 h-9 rounded-lg bg-gray-200 flex items-center justify-center">
          <FontAwesomeIcon icon={faStar} className="text-gray-400 text-sm" />
        </div>
        <div className="flex-1 min-w-0">
          ...
          <button
            ...
            disabled={saving}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium text-gray-700 bg-white border border-gray-300 transition-all duration-200 hover:bg-gray-50 hover:border-gray-400 disabled:opacity-50 disabled:cursor-not-allowed"
          >

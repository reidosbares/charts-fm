...
const awardColorSchemes: Record<string, {
  ...
  'Taste Maker': {
    bgGradient: 'from-pink-50 to-fuchsia-50 dark:from-pink-950/40 dark:to-fuchsia-950/40',
...
export default function RecordBlock({ title, record, value, groupId, isUser, activeTab }: RecordBlockProps) {
  ...
  const colorScheme = isUser && englishTitle && awardColorSchemes[englishTitle]
    ...
    : {
        bgGradient: 'from-white/80 to-white/80 dark:from-[var(--surface-card)] dark:to-[var(--surface-card)]',

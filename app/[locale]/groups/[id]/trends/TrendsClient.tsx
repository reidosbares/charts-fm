...
export default function TrendsClient({ trends, groupId, userId }: TrendsClientProps) {
  ...
  return (
    <div className="space-y-4 md:space-y-6">
      ...
      {trends.weekStart && (
        <div className="bg-gradient-to-r from-[var(--theme-primary-light)] to-[var(--theme-primary-lighter)] dark:from-[rgb(var(--theme-primary-rgb)/0.25)] dark:via-[rgb(var(--theme-primary-rgb)/0.12)] dark:to-[var(--surface-card)] rounded-xl shadow-sm dark:shadow-[0_0_24px_rgb(var(--theme-primary-rgb)/0.15)] p-4 md:p-6 border border-theme dark:border-[rgb(var(--theme-primary-rgb)/0.4)]">
